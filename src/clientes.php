...
<main>
    <h1>Clientes</h1>
    <a href="controllers/crear.php" class="button">Agregar Cliente</a>
                ...
                <?php if($result->num_rows > 0): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="controllers/eliminar.php?id=<?= $row['id'] ?>" onclick="return confirm('¿Eliminar cliente?')">Eliminar</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                <?php else: ?>
