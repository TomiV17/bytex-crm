...
$sql = "SELECT * FROM proveedores $where_sql ORDER BY nombre ASC";
...
.modal {
    ...
    background: rgba(255, 255, 255, 0.2); /* blanco con opacidad */
...
<main>
<h1>Proveedores</h1>
<a href="controllers/proveedores_form.php" class="button">Agregar Proveedor</a>
...
<form method="get" style="margin: 15px 0;">
    ...
    <a href="proveedores.php" style="margin-left:10px;">Limpiar</a>
</form>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <?php endif; ?>
            <td>
                <a href="controllers/editar_proveedor.php?id=<?= $p['id'] ?>">Editar</a> |
                <a href="controllers/eliminar_proveedor.php?id=<?= $p['id'] ?>" onclick="return confirm('¿Eliminar proveedor?')">Eliminar</a>
            </td>
        </tr>
        <?php endwhile; ?>
        <?php else: ?>
        <tr><td colspan="<?= $is_global?8:7 ?>" style="text-align:center;">No hay proveedores</td></tr>
        <?php endif; ?>
    </tbody>
</table>
</main>
